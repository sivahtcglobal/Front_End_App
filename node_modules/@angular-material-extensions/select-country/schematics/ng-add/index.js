...
function addModuleToImports(options) {
    return (host, context) => {
        ...
        const project = helpers_1.getProjectFromWorkspace(workspace, 
        // Takes the first project in case it's not provided by CLI
        options.project ? options.project : Object.keys(workspace.projects)[0]);
        const moduleName = `MatSelectCountryModule`;
        helpers_1.addModuleImportToRootModule(host, moduleName, '@angular-material-extensions/select-country', project);
